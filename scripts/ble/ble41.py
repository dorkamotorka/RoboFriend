...
def rssi_to_distance(rssi):
	measured_power = -54  # RSSI at 1 meter
	env_factor = 2 # 2-4
	
	return 10 ** ((measured_power - rssi) / (10*env_factor))

"""
Main loop
"""
if __name__ == '__main__':
	print("Initializing BLE Socket...")
	...
	while True:	
		rssi = device_inquiry_with_rssi(sock)
		if rssi:
			distance = rssi_to_distance(rssi)
			print(distance)
		check = bluetooth.lookup_name('78:88:6D:3A:EA:E3', timeout=5)
		if not check:
